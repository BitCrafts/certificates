...
/// <summary>
/// Repository interface for certificate persistence (port)
/// </summary>
public interface ICertificateRepository
{
    Task<Certificate?> GetByIdAsync(long id, CancellationToken ct = default);
    Task<IReadOnlyList<Certificate>> GetAllAsync(CancellationToken ct = default);
    Task<IReadOnlyList<Certificate>> GetByKindAsync(string kind, CancellationToken ct = default);
    Task<long> AddAsync(Certificate certificate, CancellationToken ct = default);
